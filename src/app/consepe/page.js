...
export default function Consepe() {
  return (
    <>
      ...
      <meta name="description" content="Conselho Superior de Ensino, Pesquisa e Extensão - Representação Estudantil do DCE UFPB"></meta>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-sky-50 p-8 rounded-lg mb-12">
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                O <strong>Conselho Superior de Ensino, Pesquisa e Extensão (CONSEPE)</strong> é o órgão deliberativo superior da Universidade Federal da Paraíba em matéria de natureza acadêmica.
              </p>
              
              <h3 className="text-xl font-semibold mb-4 text-sky-800">Composição do CONSEPE:</h3>
              <ul className="text-gray-700 space-y-2 mb-6">
                <li>• Reitor (Presidente)</li>
                <li>• Vice-Reitor (Vice-Presidente)</li>
                <li>• Pró-Reitor de Graduação</li>
                <li>• Pró-Reitor de Pós-Graduação e Pesquisa</li>
                <li>• Pró-Reitor de Extensão e Assuntos Comunitários</li>
                <li>• Dois representantes docentes de cada Centro (Campi I, II e III)</li>
              ...
              <div className="bg-sky-100 p-4 rounded-lg">
                <p className="text-sky-800 font-medium">
                  <strong>Importante:</strong> O CONSEPE é responsável por deliberar sobre questões acadêmicas fundamentais, incluindo criação de cursos, regulamentação acadêmica e políticas de ensino, pesquisa e extensão.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">
              Representantes Estudantis do DCE no CONSEPE
            </h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {representantesConsepe.map((representante, index) => (
                <div key={index} className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow">
                  <div className="space-y-6">
                    ...
                    {/* Suplente */}
                    {representante.suplente && representante.suplente !== "Suplente não informado" ? (
                      <div className="text-center">
                      ...
                      <div className="text-center">
                        ...
                        <p className="text-gray-400 text-sm">Suplente não informado</p>
                      </div>
                    )}
                  </div>
                </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-8 text-center">
              <p className="text-gray-600 mb-4">
                Acompanhe as reuniões e participe das discussões
              </p>
              <a 
      ...
      <section className="bg-sky-500 text-white py-16">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            O DCE representa você no CONSEPE. Entre em contato conosco para sugerir pautas e acompanhar as discussões que impactam sua vida acadêmica.
          </p>
